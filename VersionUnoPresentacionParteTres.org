...
- @@html:<span style="color: #8be9fd;"><strong>Líneas verticales:</strong></span>@@ (líneas de bits), transportan el dato almacenado en una celda.
...
#+ATTR_REVEAL: :frag (appear)
- @@html:<span style="color: #f1fa8c;"><strong>Multiplexación en el tiempo:</strong></span>@@(11 líneas en lugar de 22):
...
<div class="concepto-box espacial">
  <strong>Terminales:</strong> Circuitos integrados se montan con patillas que los conectan al exterior. Ejemplo: EPROM de 8 Mb necesita 32 terminales.
</div>
#+end_export
...
<div class="col2">
  <div>
    ...
    <p style="font-size: 0.9em;">
      <strong>Señales transferidas por los terminales:</strong>
    </p>

    <ul style="font-size: 0.8em;">
      <li>Dirección de palabra a la que se accede: \(n = \log_2(W)\).</li>
      <li>El dato a leer (ocho líneas).</li>
      <li>Línea de alimentación del chip.</li>
      <li>Un terminal de tierra.</li>
      <li>Habilitación del chip (validar dirección dada por el bus).</li>
      <li>Una tensión de programación.</li>
    </ul>
...
[[./imagenes/encapsulacion_chips.png]]

* 9. Organización en módulos
** @@html:<i class="fas fa-cubes"></i>@@ Organización en módulos
#+ATTR_REVEAL: :frag (appear)
- Número de chips igual al número de bits por palabra.
- RAM 256 K palabras (8 bits c/u): @@html:<span style="color: #ff79c6;">ocho chips de 256 KB</span>@@.
- Memoria mayor = matriz de chips. Ejemplo: 1 M de palabras (8 bits c/u) requiere @@html:<span style="color: #ff79c6;">cuatro columnas de chips</span>@@ similares a la de 256 KB.
...
<div style="display:flex; justify-content:center; gap:10px; margin-bottom:20px;">
  <div style="background-color:#d35400; padding:10px; border-radius:5px; color:white; text-align:center;">P1<br><small>1 (001)</small></div>
  <div style="background-color:#d35400; padding:10px; border-radius:5px; color:white; text-align:center;">P2<br><small>2 (010)</small></div>
  ...
  <div style="background-color:#d35400; padding:10px; border-radius:5px; color:white; text-align:center;">P4<br><small>4 (100)</small></div>
...
- @@html:<strong>@@C1@@html:</strong>@@ \(= D3 \oplus D5 \oplus D7 = 1 \oplus 0 \oplus 1 = 0 \implies\) @@html:<span style="color:#F0C040;"><strong>C1 = 0</strong></span>@@
- @@html:<strong>@@C2@@html:</strong>@@ \(= D3 \oplus D6 \oplus D7 = 1 \oplus 1 \oplus 1 = 1 \implies\) @@html:<span style="color:#F0C040;"><strong>C2 = 1</strong></span>@@
- @@html:<strong>@@C4@@html:</strong>@@ \(= D5 \oplus D6 \oplus D7 = 0 \oplus 1 \oplus 1 = 0 \implies\) @@html:<span style="color:#F0C040;"><strong>C4 = 0</strong></span>@@
...
- @@html:<strong>@@C1@@html:</strong>@@ \(= D3 \oplus D5 \oplus D7 = 1 \oplus 0 \oplus 1 =\) @@html:<span style="color:#00B894;"><strong>0</strong></span>@@
- @@html:<strong>@@C2@@html:</strong>@@ \(= D3 \oplus D6 \oplus D7 = 1 \oplus\) @@html:<span style="color:#D63031;"><strong>0</strong></span>@@ \(\oplus 1 =\) @@html:<span style="color:#D63031;"><strong>0</strong></span>@@
- @@html:<strong>@@C4@@html:</strong>@@ \(= D5 \oplus D6 \oplus D7 = 0 \oplus\) @@html:<span style="color:#D63031;"><strong>0</strong></span>@@ \(\oplus 1 =\) @@html:<span style="color:#D63031;"><strong>1</strong></span>@@
...
<div class="concepto-box hit" style="margin-top:20px;">
  ...
  <div style="text-align:center; font-size:1.2em; margin:10px 0;">\(S = (C4\;C2\;C1) = 110_2\)</div>
...
<div class="col2">
  <div>
    <ul style="font-size: 0.9em;">
      <li><strong>Contador de Ráfagas y Control:</strong> Gestionan la inicialización en flancos ascendentes.</li>
      <li><strong>Empaquetado de Datos:</strong> Se realiza automáticamente tras la latencia configurada.</li>
    </ul>
  </div>
  <div>
#+end_export
...
<div class="col2">
  <div>
    ...
    <ul style="font-size: 0.8em;">
      <li><strong>Conexión:</strong> Celdas organizadas en paralelo.</li>
      <li><strong>Ventaja:</strong> Acceso aleatorio rapidísimo a nivel de byte. Lee instrucciones directamente.</li>
      <li><strong>Aplicación:</strong> Código de arranque (firmware) en microcontroladores y sistemas embebidos.</li>
    </ul>
  </div>
  <div>
    <div class="concepto-box warn">
    ...
    <ul style="font-size: 0.8em;">
      <li><strong>Conexión:</strong> Celdas en serie (cadenas de 16-32 transistores).</li>
      <li><strong>Ventaja:</strong> Ocupan menos espacio físico. Muy baratas y capacidad gigantesca.</li>
      <li><strong>Limitación:</strong> Obligada a leer/escribir en bloques/páginas. Sin acceso aleatorio directo.</li>
      <li><strong>Aplicación:</strong> Almacenamiento masivo (USBs, SDs, SSDs).</li>
    </ul>
  </div>
</div>
#+end_export
...
<div class="text-center">
  ...
  <p class="muted small">Bibliografía: Estructura y Organización de Computadores (Basado en Capítulos 5 y 6).</p>
</div>
#+end_export
